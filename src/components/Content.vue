    ...
    <div class="container" style="background-color: white; position: relative; z-index: 10; padding-bottom: 20px;       ">
        <div class="about-section">
            ...
            <p><span class="bold-ps">We focus on the technology. </span>Our bulbs have been re-engineered from scratch
                to
                make them more resistant to harsh voltages and provide better quality light as well as more light for
                less
                watts.
            </p>
            ...
            <p><span class="bold-ps">Stress tested before shipping. </span>Our bulbs undergo thorough testing before
                they
